...
public class addfacilitytype implements IRemote{
	public static addfacilitytype mostCurrent;
	public static RemoteObject processBA;
    public static boolean processGlobalsRun;
    public static RemoteObject myClass;
    public static RemoteObject remoteMe;
	public addfacilitytype() {
		mostCurrent = this;
	}
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("addfacilitytype"), "b4a.example.addfacilitytype");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, addfacilitytype.class);
...
public static RemoteObject _panelname = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
public static RemoteObject _paneladdpanel = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
public static RemoteObject _paneladdfacility = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
...
public static RemoteObject _pnlistfac = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
public static RemoteObject _clvfac = RemoteObject.declareNull("b4a.example3.customlistview");
...
public static RemoteObject _pnlquantity = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static RemoteObject _idelete = RemoteObject.createImmutable(0);
public static RemoteObject _btnadd = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
public static RemoteObject _editname = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static b4a.example.multipartpost _multipartpost = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",addfacilitytype.mostCurrent._activity,"AddBuildingFacility",Debug.moduleToString(b4a.example.addbuildingfacility.class),"AddPhoto",Debug.moduleToString(b4a.example.addphoto.class),"BrowseGallery",Debug.moduleToString(b4a.example.browsegallery.class),"BtnAdd",addfacilitytype.mostCurrent._btnadd,"btnDelete",addfacilitytype.mostCurrent._btndelete,"BuildingList",Debug.moduleToString(b4a.example.buildinglist.class),"CLVFac",addfacilitytype.mostCurrent._clvfac,"EditBuildingFacility",Debug.moduleToString(b4a.example.editbuildingfacility.class),"EditName",addfacilitytype.mostCurrent._editname,"EducationalBuilding",Debug.moduleToString(b4a.example.educationalbuilding.class),"EducationalDetail",Debug.moduleToString(b4a.example.educationaldetail.class),"EducationalEdit",Debug.moduleToString(b4a.example.educationaledit.class),"FileUtil",Debug.moduleToString(b4a.example.fileutil.class),"FunctionAll",Debug.moduleToString(b4a.example.functionall.class),"Gallery",Debug.moduleToString(b4a.example.gallery.class),"HealthBuilding",Debug.moduleToString(b4a.example.healthbuilding.class),"HealthDetail",Debug.moduleToString(b4a.example.healthdetail.class),"HealthEdit",Debug.moduleToString(b4a.example.healthedit.class),"Help",Debug.moduleToString(b4a.example.help.class),"Home",Debug.moduleToString(b4a.example.home.class),"HomeAdmin",Debug.moduleToString(b4a.example.homeadmin.class),"HouseBuilding",Debug.moduleToString(b4a.example.housebuilding.class),"HouseDetail",Debug.moduleToString(b4a.example.housedetail.class),"HttpUtils2Service",addfacilitytype.mostCurrent._httputils2service,"idelete",addfacilitytype._idelete,"idfaci",addfacilitytype.mostCurrent._idfaci,"Label1",addfacilitytype.mostCurrent._label1,"ListItem",addfacilitytype.mostCurrent._listitem,"LoaderImage",Debug.moduleToString(b4a.example.loaderimage.class),"Login",Debug.moduleToString(b4a.example.login.class),"Main",Debug.moduleToString(b4a.example.main.class),"MainCamera",Debug.moduleToString(b4a.example.maincamera.class),"ManualPosition",Debug.moduleToString(b4a.example.manualposition.class),"MsmeBuilding",Debug.moduleToString(b4a.example.msmebuilding.class),"MsmeDetail",Debug.moduleToString(b4a.example.msmedetail.class),"MsmeEdit",Debug.moduleToString(b4a.example.msmeedit.class),"MultipartPost",Debug.moduleToString(b4a.example.multipartpost.class),"namefc",addfacilitytype.mostCurrent._namefc,"numfc",addfacilitytype.mostCurrent._numfc,"OfficeBuilding",Debug.moduleToString(b4a.example.officebuilding.class),"OfficeDetail",Debug.moduleToString(b4a.example.officedetail.class),"OfficeEdit",Debug.moduleToString(b4a.example.officeedit.class),"PanelAddFacility",addfacilitytype.mostCurrent._paneladdfacility,"PanelAddPanel",addfacilitytype.mostCurrent._paneladdpanel,"PanelBar",addfacilitytype.mostCurrent._panelbar,"PanelName",addfacilitytype.mostCurrent._panelname,"PanelToolBar",addfacilitytype.mostCurrent._paneltoolbar,"PnListFac",addfacilitytype.mostCurrent._pnlistfac,"PnlQuantity",addfacilitytype.mostCurrent._pnlquantity,"ScrollView1",addfacilitytype.mostCurrent._scrollview1,"SearchBuilding",Debug.moduleToString(b4a.example.searchbuilding.class),"searchWorship",Debug.moduleToString(b4a.example.searchworship.class),"ShowImage",Debug.moduleToString(b4a.example.showimage.class),"Starter",Debug.moduleToString(b4a.example.starter.class),"WorshipBuilding",Debug.moduleToString(b4a.example.worshipbuilding.class),"WorshipDetail",Debug.moduleToString(b4a.example.worshipdetail.class),"WorshipEdit",Debug.moduleToString(b4a.example.worshipedit.class),"xui",addfacilitytype._xui};
}
}