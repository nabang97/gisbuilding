...
public class browsegallery implements IRemote{
	public static browsegallery mostCurrent;
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("browsegallery"), "b4a.example.browsegallery");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, browsegallery.class);
...
public static RemoteObject _image = RemoteObject.declareNull("anywheresoftware.b4a.objects.ImageViewWrapper");
