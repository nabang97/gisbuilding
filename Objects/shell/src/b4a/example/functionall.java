...
public class functionall implements IRemote{
	public static functionall mostCurrent;
...
public boolean isSingleton() {
     ...
     private static PCBA pcBA = new PCBA(null, functionall.class);
    static {
		mostCurrent = new functionall();
        remoteMe = RemoteObject.declareNull("b4a.example.functionall");
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("functionall"), "b4a.example.functionall");
        RDebug.INSTANCE.eventTargets.put(new DeviceClass("b4a.example.functionall"), new java.lang.ref.WeakReference<PCBA> (pcBA));
	}
