...
public class msmedetail implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("msmedetail"), "b4a.example.msmedetail");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, msmedetail.class);
...
public static RemoteObject _typeofmsme = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static b4a.example.multipartpost _multipartpost = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",msmedetail.mostCurrent._activity,"AddBuildingFacility",Debug.moduleToString(b4a.example.addbuildingfacility.class),"AddFacilityType",Debug.moduleToString(b4a.example.addfacilitytype.class),"AddPhoto",Debug.moduleToString(b4a.example.addphoto.class),"AddPicture",msmedetail.mostCurrent._addpicture,"BackArrow",msmedetail.mostCurrent._backarrow,"BrowseGallery",Debug.moduleToString(b4a.example.browsegallery.class),"btnGallery",msmedetail.mostCurrent._btngallery,"btnRoute",msmedetail.mostCurrent._btnroute,"BuildingArea",msmedetail.mostCurrent._buildingarea,"BuildingList",Debug.moduleToString(b4a.example.buildinglist.class),"clv",msmedetail.mostCurrent._clv,"CLV1",msmedetail.mostCurrent._clv1,"Construction",msmedetail.mostCurrent._construction,"editBtn",msmedetail.mostCurrent._editbtn,"EditBuildingFacility",Debug.moduleToString(b4a.example.editbuildingfacility.class),"editFacility",msmedetail.mostCurrent._editfacility,"EducationalBuilding",Debug.moduleToString(b4a.example.educationalbuilding.class),"EducationalDetail",Debug.moduleToString(b4a.example.educationaldetail.class),"EducationalEdit",Debug.moduleToString(b4a.example.educationaledit.class),"Electricity",msmedetail.mostCurrent._electricity,"FileUtil",Debug.moduleToString(b4a.example.fileutil.class),"FunctionAll",Debug.moduleToString(b4a.example.functionall.class),"Gallery",Debug.moduleToString(b4a.example.gallery.class),"HealthBuilding",Debug.moduleToString(b4a.example.healthbuilding.class),"HealthDetail",Debug.moduleToString(b4a.example.healthdetail.class),"HealthEdit",Debug.moduleToString(b4a.example.healthedit.class),"Help",Debug.moduleToString(b4a.example.help.class),"Home",Debug.moduleToString(b4a.example.home.class),"HomeAdmin",Debug.moduleToString(b4a.example.homeadmin.class),"HouseBuilding",Debug.moduleToString(b4a.example.housebuilding.class),"HouseDetail",Debug.moduleToString(b4a.example.housedetail.class),"HttpUtils2Service",msmedetail.mostCurrent._httputils2service,"ids",msmedetail.mostCurrent._ids,"ImageView1",msmedetail.mostCurrent._imageview1,"Label1",msmedetail.mostCurrent._label1,"LandArea",msmedetail.mostCurrent._landarea,"lat",msmedetail._lat,"LblEdit",msmedetail.mostCurrent._lbledit,"LblFacility",msmedetail.mostCurrent._lblfacility,"ListItem",msmedetail.mostCurrent._listitem,"lng",msmedetail._lng,"LoaderImage",Debug.moduleToString(b4a.example.loaderimage.class),"Login",Debug.moduleToString(b4a.example.login.class),"Main",Debug.moduleToString(b4a.example.main.class),"MainCamera",Debug.moduleToString(b4a.example.maincamera.class),"ManualPosition",Debug.moduleToString(b4a.example.manualposition.class),"MsmeBuilding",Debug.moduleToString(b4a.example.msmebuilding.class),"MsmeEdit",Debug.moduleToString(b4a.example.msmeedit.class),"MsmeName",msmedetail.mostCurrent._msmename,"MultipartPost",Debug.moduleToString(b4a.example.multipartpost.class),"namefc",msmedetail.mostCurrent._namefc,"numfc",msmedetail.mostCurrent._numfc,"OfficeBuilding",Debug.moduleToString(b4a.example.officebuilding.class),"OfficeDetail",Debug.moduleToString(b4a.example.officedetail.class),"OfficeEdit",Debug.moduleToString(b4a.example.officeedit.class),"Panel4",msmedetail.mostCurrent._panel4,"PanelBuildingList",msmedetail.mostCurrent._panelbuildinglist,"PanelButton",msmedetail.mostCurrent._panelbutton,"PanelGallery",msmedetail.mostCurrent._panelgallery,"PanelMap",msmedetail.mostCurrent._panelmap,"PanelToolBar",msmedetail.mostCurrent._paneltoolbar,"ParkingArea",msmedetail.mostCurrent._parkingarea,"PFacility",msmedetail.mostCurrent._pfacility,"ScrollImage",msmedetail.mostCurrent._scrollimage,"ScrollView1",msmedetail.mostCurrent._scrollview1,"SearchBuilding",Debug.moduleToString(b4a.example.searchbuilding.class),"searchWorship",Debug.moduleToString(b4a.example.searchworship.class),"ShowImage",Debug.moduleToString(b4a.example.showimage.class),"StandingYear",msmedetail.mostCurrent._standingyear,"Starter",Debug.moduleToString(b4a.example.starter.class),"TabHost1",msmedetail.mostCurrent._tabhost1,"TitleBar",msmedetail.mostCurrent._titlebar,"TypeOfMsme",msmedetail.mostCurrent._typeofmsme,"WebViewRoute",msmedetail.mostCurrent._webviewroute,"WorshipBuilding",Debug.moduleToString(b4a.example.worshipbuilding.class),"WorshipDetail",Debug.moduleToString(b4a.example.worshipdetail.class),"WorshipEdit",Debug.moduleToString(b4a.example.worshipedit.class),"xui",msmedetail._xui};
}
}