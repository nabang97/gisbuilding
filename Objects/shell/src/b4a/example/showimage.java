...
public class showimage implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("showimage"), "b4a.example.showimage");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, showimage.class);
...
public static RemoteObject _sourceimagerect = RemoteObject.declareNull("anywheresoftware.b4a.objects.drawable.CanvasWrapper.RectWrapper");
public static RemoteObject _touchimageviewrect = RemoteObject.declareNull("anywheresoftware.b4a.objects.drawable.CanvasWrapper.RectWrapper");
public static RemoteObject _imageshow = RemoteObject.declareNull("uk.co.martinpearman.b4a.touchimageview.TouchImageViewWrapper");
