...
public class camex2 extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.example.camex2");
            if (htSubs == null) {
...
public ResumableSub_CreateSurface(b4a.example.camex2 parent) {
this.parent = parent;
}
...
public ResumableSub_FocusAndTakePicture(b4a.example.camex2 parent,int _mytaskindex) {
this.parent = parent;
...
_jo.setObject((java.lang.Object)(_camera.GetCameraCharacteristics(_id)));
...
if (true) return (_getfromcameracharacteristic("LENS_FACING")).equals((Object)(0));
...
_jo = new anywheresoftware.b4j.object.JavaObject();
_jo.setObject((java.lang.Object)(_tv.getObject()));
...
_jo = new anywheresoftware.b4j.object.JavaObject();
_jo.setObject((java.lang.Object)(_camera.GetCameraCharacteristics(BA.NumberToString(0))));
...
_jcamera.setObject((java.lang.Object)(_camera));
...
public ResumableSub_OpenCamera(b4a.example.camex2 parent,boolean _front) {
this.parent = parent;
this._front = _front;
}
b4a.example.camex2 parent;
...
public ResumableSub_PrepareSurface(b4a.example.camex2 parent,int _mytaskindex) {
this.parent = parent;
this._mytaskindex = _mytaskindex;
}
b4a.example.camex2 parent;
...
public ResumableSub_PrepareSurfaceForVideo(b4a.example.camex2 parent,int _mytaskindex,String _dir,String _filename) {
this.parent = parent;
this._mytaskindex = _mytaskindex;
this._dir = _dir;
...
parent._mediarecorder.setObject((java.lang.Object)(parent._camera.CreateMediaRecorder(parent._previewsize,_dir,_filename)));
...
_previewbuilder.setObject((java.lang.Object)(_camera.CreateVideoRequestBuilder()));
 }else {
 //BA.debugLineNum = 158;BA.debugLine="PreviewBuilder = Camera.CreatePreviewBuilder";
_previewbuilder.setObject((java.lang.Object)(_camera.CreatePreviewBuilder()));
 };
...
_previewrequest.setObject((java.lang.Object)(_camera.SetRepeatingRequest((Object)(_previewbuilder.getObject()))));
...
public ResumableSub_TakePictureNow(b4a.example.camex2 parent,int _mytaskindex) {
this.parent = parent;
this._mytaskindex = _mytaskindex;
}
b4a.example.camex2 parent;
...
_builder.setObject((java.lang.Object)(parent._camera.CreateCaptureBuilder()));
...
public ResumableSub_TakePicturesNow(b4a.example.camex2 parent,int _mytaskindex,int _numberofpictures) {
this.parent = parent;
this._mytaskindex = _mytaskindex;
...
public ResumableSub_WaitForFocusWithTimeout(b4a.example.camex2 parent,int _timeoutms) {
this.parent = parent;
