...
public class LS_educationaldetail{
...
views.get("educationname").vw.setLeft((int)((4d / 100 * width)));
views.get("educationname").vw.setWidth((int)((88d / 100 * width) - ((4d / 100 * width))));
...
views.get("educationname").vw.setTop((int)((views.get("label1").vw.getTop())+(views.get("label1").vw.getHeight())));
...
views.get("panelbuildinglist").vw.setHeight((int)((views.get("tabhost1").vw.getTop())+(views.get("tabhost1").vw.getHeight())));
