...
views.get("healthname").vw.setLeft((int)((4d / 100 * width)));
views.get("healthname").vw.setWidth((int)((88d / 100 * width) - ((4d / 100 * width))));
...
views.get("healthname").vw.setTop((int)((views.get("label1").vw.getTop())+(views.get("label1").vw.getHeight())));
