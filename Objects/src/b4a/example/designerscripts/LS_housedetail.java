...
views.get("houseid").vw.setLeft((int)((4d / 100 * width)));
views.get("houseid").vw.setWidth((int)((88d / 100 * width) - ((4d / 100 * width))));
...
views.get("houseid").vw.setTop((int)((views.get("label1").vw.getTop())+(views.get("label1").vw.getHeight())));
