...
public class LS_msme_tabdetail{

public static void LS_general(java.util.LinkedHashMap<String, anywheresoftware.b4a.keywords.LayoutBuilder.ViewWrapperAndAnchor> views, int width, int height, float scale) {
anywheresoftware.b4a.keywords.LayoutBuilder.setScaleRate(0.3);
views.get("lbltypeofmsme").vw.setHeight((int)((6d / 100 * height)));
views.get("typeofmsme").vw.setHeight((int)((views.get("lbltypeofmsme").vw.getHeight())));
views.get("lblstandingyear").vw.setHeight((int)((views.get("lbltypeofmsme").vw.getHeight())));
views.get("standingyear").vw.setHeight((int)((views.get("lbltypeofmsme").vw.getHeight())));
views.get("lblbuildingarea").vw.setHeight((int)((views.get("lbltypeofmsme").vw.getHeight())));
views.get("buildingarea").vw.setHeight((int)((views.get("lbltypeofmsme").vw.getHeight())));
views.get("lbllandarea").vw.setHeight((int)((views.get("lbltypeofmsme").vw.getHeight())));
views.get("landarea").vw.setHeight((int)((views.get("lbltypeofmsme").vw.getHeight())));
views.get("lblparkingarea").vw.setHeight((int)((views.get("lbltypeofmsme").vw.getHeight())));
views.get("parkingarea").vw.setHeight((int)((views.get("lbltypeofmsme").vw.getHeight())));
views.get("lblelectric").vw.setHeight((int)((views.get("lbltypeofmsme").vw.getHeight())));
views.get("electricity").vw.setHeight((int)((views.get("lbltypeofmsme").vw.getHeight())));
views.get("lblcons").vw.setHeight((int)((views.get("lbltypeofmsme").vw.getHeight())));
views.get("construction").vw.setHeight((int)((views.get("lbltypeofmsme").vw.getHeight())));
views.get("lblfacility").vw.setHeight((int)((views.get("lbltypeofmsme").vw.getHeight())));
views.get("label2").vw.setHeight((int)((8d / 100 * height)));
views.get("lbltypeofmsme").vw.setTop((int)((0d / 100 * height)));
views.get("typeofmsme").vw.setTop((int)((views.get("lbltypeofmsme").vw.getTop())+(views.get("lbltypeofmsme").vw.getHeight())));
views.get("lblstandingyear").vw.setTop((int)((views.get("lbltypeofmsme").vw.getTop())));
views.get("standingyear").vw.setTop((int)((views.get("lblstandingyear").vw.getTop())+(views.get("lblstandingyear").vw.getHeight())));
views.get("lblbuildingarea").vw.setTop((int)((views.get("lbltypeofmsme").vw.getTop())));
views.get("buildingarea").vw.setTop((int)((views.get("lblbuildingarea").vw.getTop())+(views.get("lblbuildingarea").vw.getHeight())));
views.get("lbllandarea").vw.setTop((int)((views.get("lbltypeofmsme").vw.getTop())));
views.get("landarea").vw.setTop((int)((views.get("lbllandarea").vw.getTop())+(views.get("lbllandarea").vw.getHeight())));
views.get("lblparkingarea").vw.setTop((int)((views.get("lbltypeofmsme").vw.getTop())));
views.get("parkingarea").vw.setTop((int)((views.get("lblparkingarea").vw.getTop())+(views.get("lblparkingarea").vw.getHeight())));
views.get("lblelectric").vw.setTop((int)((views.get("lbltypeofmsme").vw.getTop())));
views.get("electricity").vw.setTop((int)((views.get("lblelectric").vw.getTop())+(views.get("lblelectric").vw.getHeight())));
views.get("lblcons").vw.setTop((int)((views.get("lbltypeofmsme").vw.getTop())));
...
views.get("paneltypemsme").vw.setHeight((int)((views.get("typeofmsme").vw.getTop())+(views.get("typeofmsme").vw.getHeight())));
...
views.get("lbltypeofmsme").vw.setLeft((int)((0d / 100 * width)));
views.get("lbltypeofmsme").vw.setWidth((int)((84d / 100 * width) - ((0d / 100 * width))));
views.get("typeofmsme").vw.setLeft((int)((0d / 100 * width)));
views.get("typeofmsme").vw.setWidth((int)((84d / 100 * width) - ((0d / 100 * width))));
...
views.get("paneltypemsme").vw.setLeft((int)((4d / 100 * width)));
views.get("paneltypemsme").vw.setWidth((int)((88d / 100 * width) - ((4d / 100 * width))));
...
views.get("paneltypemsme").vw.setTop((int)((views.get("label2").vw.getTop())+(views.get("label2").vw.getHeight())+(2d / 100 * height)));
views.get("panel2").vw.setTop((int)((views.get("paneltypemsme").vw.getTop())+(views.get("paneltypemsme").vw.getHeight())+(2d / 100 * height)));
