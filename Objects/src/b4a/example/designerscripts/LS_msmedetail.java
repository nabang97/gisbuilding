...
views.get("msmename").vw.setLeft((int)((4d / 100 * width)));
views.get("msmename").vw.setWidth((int)((88d / 100 * width) - ((4d / 100 * width))));
...
views.get("msmename").vw.setTop((int)((views.get("label1").vw.getTop())+(views.get("label1").vw.getHeight())));
