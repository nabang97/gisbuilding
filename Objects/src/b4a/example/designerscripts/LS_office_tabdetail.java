...
views.get("lblfacility").vw.setHeight((int)((10d / 100 * width)));
views.get("label2").vw.setHeight((int)((10d / 100 * width)));
...
views.get("editbtn").vw.setLeft((int)((86d / 100 * width)));
views.get("editbtn").vw.setWidth((int)((94d / 100 * width) - ((86d / 100 * width))));
views.get("editbtn").vw.setHeight((int)((8d / 100 * width)));
views.get("editbtn").vw.setTop((int)((views.get("panel4").vw.getTop())+(2d / 100 * width)));
views.get("editfacility").vw.setTop((int)((2d / 100 * width)));
views.get("editfacility").vw.setHeight((int)((views.get("editbtn").vw.getHeight())));
views.get("editfacility").vw.setLeft((int)((82d / 100 * width)));
views.get("editfacility").vw.setWidth((int)((90d / 100 * width) - ((82d / 100 * width))));
