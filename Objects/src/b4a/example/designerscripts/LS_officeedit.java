...
views.get("officelabel").vw.setHeight((int)((5d / 100 * height)));
views.get("officelabel").vw.setTop((int)((views.get("label1").vw.getTop())+(views.get("label1").vw.getHeight())+(2d / 100 * height)));
views.get("officelabel").vw.setLeft((int)((5d / 100 * width)));
views.get("officelabel").vw.setWidth((int)((95d / 100 * width) - ((5d / 100 * width))));
...
views.get("panel1").vw.setTop((int)((views.get("officelabel").vw.getTop())+(views.get("officelabel").vw.getHeight())));
views.get("officename").vw.setHeight((int)((views.get("panel1").vw.getHeight())));
views.get("officename").vw.setLeft((int)((0d / 100 * width)));
views.get("officename").vw.setWidth((int)((90d / 100 * width) - ((0d / 100 * width))));
views.get("officename").vw.setTop((int)((0d / 100 * height)));
views.get("lbltypeofoffice").vw.setHeight((int)((views.get("officelabel").vw.getHeight())));
views.get("lbltypeofoffice").vw.setLeft((int)((5d / 100 * width)));
views.get("lbltypeofoffice").vw.setWidth((int)((95d / 100 * width) - ((5d / 100 * width))));
views.get("lbltypeofoffice").vw.setTop((int)((views.get("panel1").vw.getTop())+(views.get("panel1").vw.getHeight())+(2d / 100 * height)));
views.get("paneltypeoffice").vw.setHeight((int)((views.get("panel1").vw.getHeight())));
views.get("paneltypeoffice").vw.setTop((int)((views.get("lbltypeofoffice").vw.getTop())+(views.get("lbltypeofoffice").vw.getHeight())));
...
views.get("typeofoffice").vw.setHeight((int)((views.get("paneltypeoffice").vw.getHeight())));
views.get("typeofoffice").vw.setTop((int)((views.get("officename").vw.getTop())));
...
views.get("lblstandingyear").vw.setTop((int)((views.get("paneltypeoffice").vw.getTop())+(views.get("paneltypeoffice").vw.getHeight())+(2d / 100 * height)));
...
views.get("panel2").vw.setHeight((int)((views.get("paneltypeoffice").vw.getHeight())));
...
views.get("standingyear").vw.setTop((int)((views.get("typeofoffice").vw.getTop())));
