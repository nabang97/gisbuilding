...
views.get("lblwelcome2").vw.setTop((int)((33d / 100 * height)));
views.get("lblwelcome2").vw.setHeight((int)((41d / 100 * height) - ((33d / 100 * height))));
...
views.get("btnadmin").vw.setHeight((int)((82d / 100 * height) - ((75d / 100 * height))));
views.get("btnguest").vw.setTop((int)((75d / 100 * height)));
views.get("btnguest").vw.setHeight((int)((82d / 100 * height) - ((75d / 100 * height))));
