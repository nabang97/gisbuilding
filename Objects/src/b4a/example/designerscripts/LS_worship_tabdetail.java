...
public class LS_worship_tabdetail{

public static void LS_general(java.util.LinkedHashMap<String, anywheresoftware.b4a.keywords.LayoutBuilder.ViewWrapperAndAnchor> views, int width, int height, float scale) {
anywheresoftware.b4a.keywords.LayoutBuilder.setScaleRate(0.3);
views.get("lbltypeofworship").vw.setHeight((int)((6d / 100 * height)));
views.get("typeofworship").vw.setHeight((int)((views.get("lbltypeofworship").vw.getHeight())));
views.get("lblstandingyear").vw.setHeight((int)((views.get("lbltypeofworship").vw.getHeight())));
views.get("standingyear").vw.setHeight((int)((views.get("lbltypeofworship").vw.getHeight())));
views.get("lblbuildingarea").vw.setHeight((int)((views.get("lbltypeofworship").vw.getHeight())));
views.get("buildingarea").vw.setHeight((int)((views.get("lbltypeofworship").vw.getHeight())));
views.get("lbllandarea").vw.setHeight((int)((views.get("lbltypeofworship").vw.getHeight())));
views.get("landarea").vw.setHeight((int)((views.get("lbltypeofworship").vw.getHeight())));
views.get("lblparkingarea").vw.setHeight((int)((views.get("lbltypeofworship").vw.getHeight())));
views.get("parkingarea").vw.setHeight((int)((views.get("lbltypeofworship").vw.getHeight())));
views.get("lblelectric").vw.setHeight((int)((views.get("lbltypeofworship").vw.getHeight())));
views.get("electricity").vw.setHeight((int)((views.get("lbltypeofworship").vw.getHeight())));
views.get("lblcons").vw.setHeight((int)((views.get("lbltypeofworship").vw.getHeight())));
views.get("construction").vw.setHeight((int)((views.get("lbltypeofworship").vw.getHeight())));
views.get("lblfacility").vw.setHeight((int)((views.get("lbltypeofworship").vw.getHeight())));
views.get("label2").vw.setHeight((int)((8d / 100 * height)));
views.get("editbtn").vw.setHeight((int)((10d / 100 * height)));
views.get("lbltypeofworship").vw.setTop((int)((0d / 100 * height)));
views.get("typeofworship").vw.setTop((int)((views.get("lbltypeofworship").vw.getTop())+(views.get("lbltypeofworship").vw.getHeight())));
views.get("lblstandingyear").vw.setTop((int)((views.get("lbltypeofworship").vw.getTop())));
views.get("standingyear").vw.setTop((int)((views.get("lblstandingyear").vw.getTop())+(views.get("lblstandingyear").vw.getHeight())));
views.get("lblbuildingarea").vw.setTop((int)((views.get("lbltypeofworship").vw.getTop())));
views.get("buildingarea").vw.setTop((int)((views.get("lblbuildingarea").vw.getTop())+(views.get("lblbuildingarea").vw.getHeight())));
views.get("lbllandarea").vw.setTop((int)((views.get("lbltypeofworship").vw.getTop())));
views.get("landarea").vw.setTop((int)((views.get("lbllandarea").vw.getTop())+(views.get("lbllandarea").vw.getHeight())));
views.get("lblparkingarea").vw.setTop((int)((views.get("lbltypeofworship").vw.getTop())));
views.get("parkingarea").vw.setTop((int)((views.get("lblparkingarea").vw.getTop())+(views.get("lblparkingarea").vw.getHeight())));
views.get("lblelectric").vw.setTop((int)((views.get("lbltypeofworship").vw.getTop())));
views.get("electricity").vw.setTop((int)((views.get("lblelectric").vw.getTop())+(views.get("lblelectric").vw.getHeight())));
views.get("lblcons").vw.setTop((int)((views.get("lbltypeofworship").vw.getTop())));
...
views.get("paneltypeworship").vw.setHeight((int)((views.get("typeofworship").vw.getTop())+(views.get("typeofworship").vw.getHeight())));
...
views.get("panel4").vw.setHeight((int)((views.get("panelelectricity").vw.getTop())+(views.get("panelelectricity").vw.getHeight())+(10d / 100 * height)));
...
views.get("editfacility").vw.setLeft((int)((75d / 100 * width)));
views.get("editfacility").vw.setWidth((int)((92d / 100 * width) - ((75d / 100 * width))));
views.get("pfacility").vw.setTop((int)((views.get("panel4").vw.getTop())+(views.get("panel4").vw.getHeight())+(3d / 100 * height)));
