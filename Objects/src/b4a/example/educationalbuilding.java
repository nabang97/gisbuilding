...
public class educationalbuilding extends Activity implements B4AActivity{
	public static educationalbuilding mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new anywheresoftware.b4a.ShellBA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.educationalbuilding");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (educationalbuilding).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.educationalbuilding");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.educationalbuilding", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (educationalbuilding) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (educationalbuilding) Resume **");
...
@Override
 ...
 protected void onStop() {
    ...
    public static Class<?> getObject() {
		return educationalbuilding.class;
	}
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (educationalbuilding) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        if (mostCurrent != null)
...
RDebugUtils.currentModule="educationalbuilding";
if (Debug.shouldDelegate(mostCurrent.activityBA, "activity_create"))
	return (String) Debug.delegate(mostCurrent.activityBA, "activity_create", new Object[] {_firsttime});
RDebugUtils.currentLine=31784960;
 //BA.debugLineNum = 31784960;BA.debugLine="Sub Activity_Create(FirstTime As Boolean)";
RDebugUtils.currentLine=31784962;
 //BA.debugLineNum = 31784962;BA.debugLine="Activity.LoadLayout(\"MainScrollView\")";
mostCurrent._activity.LoadLayout("MainScrollView",mostCurrent.activityBA);
RDebugUtils.currentLine=31784963;
 //BA.debugLineNum = 31784963;BA.debugLine="ScrollView1.Panel.Width=100%y";
...
RDebugUtils.currentLine=31784970;
 //BA.debugLineNum = 31784970;BA.debugLine="TitleBar.Text=\"Building List\"";
mostCurrent._titlebar.setText(BA.ObjectToCharSequence("Building List"));
RDebugUtils.currentLine=31784973;
 //BA.debugLineNum = 31784973;BA.debugLine="WebViewTest.Initialize(\"\")";
mostCurrent._webviewtest.Initialize(mostCurrent.activityBA,"");
RDebugUtils.currentLine=31784974;
 //BA.debugLineNum = 31784974;BA.debugLine="Activity.AddView(WebViewTest,0,6%y,100%x,50%y)";
...
RDebugUtils.currentLine=31784975;
 //BA.debugLineNum = 31784975;BA.debugLine="WebViewTest.LoadURL(Main.Server&\"educational_buil";
mostCurrent._webviewtest.LoadUrl(mostCurrent._main._server+"educational_building.php");
RDebugUtils.currentLine=31784978;
 //BA.debugLineNum = 31784978;BA.debugLine="ScrollView1.Panel.Height = CLV2.sv.Height";
mostCurrent._scrollview1.getPanel().setHeight(mostCurrent._clv2._sv.getHeight());
RDebugUtils.currentLine=31784979;
 //BA.debugLineNum = 31784979;BA.debugLine="ScrollView1.Top = WebViewTest.Height+WebViewTest.";
...
RDebugUtils.currentLine=31784982;
 //BA.debugLineNum = 31784982;BA.debugLine="End Sub";
return "";
}
public static String  _activity_pause(boolean _userclosed) throws Exception{
RDebugUtils.currentModule="educationalbuilding";
RDebugUtils.currentLine=31916032;
 //BA.debugLineNum = 31916032;BA.debugLine="Sub Activity_Pause (UserClosed As Boolean)";
...
RDebugUtils.currentLine=31850497;
 //BA.debugLineNum = 31850497;BA.debugLine="CLV2.Clear";
parent.mostCurrent._clv2._clear();
RDebugUtils.currentLine=31850498;
 //BA.debugLineNum = 31850498;BA.debugLine="Dim j As HttpJob";
_j = new anywheresoftware.b4a.samples.httputils2.httpjob();
RDebugUtils.currentLine=31850499;
 //BA.debugLineNum = 31850499;BA.debugLine="j.Initialize(\"\",Me)";
_j._initialize(processBA,"",educationalbuilding.getObject());
RDebugUtils.currentLine=31850500;
 //BA.debugLineNum = 31850500;BA.debugLine="j.Download(Main.Server&\"mobile/datapendidikan.php";
_j._download(parent.mostCurrent._main._server+"mobile/datapendidikan.php");
RDebugUtils.currentLine=31850502;
 //BA.debugLineNum = 31850502;BA.debugLine="Wait For (j) JobDone (j As HttpJob)";
...
RDebugUtils.currentLine=31850503;
 //BA.debugLineNum = 31850503;BA.debugLine="JobDone(j)";
_jobdone(_j);
...
RDebugUtils.currentLine=32112640;
 //BA.debugLineNum = 32112640;BA.debugLine="Sub JobDone (j As HttpJob)";
RDebugUtils.currentLine=32112641;
 //BA.debugLineNum = 32112641;BA.debugLine="If j.Success Then";
if (_j._success) { 
RDebugUtils.currentLine=32112642;
 //BA.debugLineNum = 32112642;BA.debugLine="Log(j.GetString)";
anywheresoftware.b4a.keywords.Common.Log(_j._getstring());
RDebugUtils.currentLine=32112643;
 //BA.debugLineNum = 32112643;BA.debugLine="Dim parser As JSONParser";
_parser = new anywheresoftware.b4a.objects.collections.JSONParser();
RDebugUtils.currentLine=32112644;
 //BA.debugLineNum = 32112644;BA.debugLine="parser.Initialize(j.GetString)";
_parser.Initialize(_j._getstring());
RDebugUtils.currentLine=32112645;
 //BA.debugLineNum = 32112645;BA.debugLine="Dim root As Map = parser.NextObject";
_root = new anywheresoftware.b4a.objects.collections.Map();
_root = _parser.NextObject();
RDebugUtils.currentLine=32112646;
 //BA.debugLineNum = 32112646;BA.debugLine="Dim features As List = root.Get(\"features\")";
...
RDebugUtils.currentLine=32112647;
 //BA.debugLineNum = 32112647;BA.debugLine="For Each colfeatures As Map In features";
...
RDebugUtils.currentLine=32112649;
 //BA.debugLineNum = 32112649;BA.debugLine="Dim properties As Map = colfeatures.Get(\"proper";
...
RDebugUtils.currentLine=32112650;
 //BA.debugLineNum = 32112650;BA.debugLine="Dim nama As String = properties.Get(\"nama\")";
_nama = BA.ObjectToString(_properties.Get((Object)("nama")));
RDebugUtils.currentLine=32112651;
 //BA.debugLineNum = 32112651;BA.debugLine="Dim id As String = properties.Get(\"id\")";
_id = BA.ObjectToString(_properties.Get((Object)("id")));
RDebugUtils.currentLine=32112652;
 //BA.debugLineNum = 32112652;BA.debugLine="Dim content As String = nama";
_content = _nama;
RDebugUtils.currentLine=32112655;
 //BA.debugLineNum = 32112655;BA.debugLine="CLV2.Add(CreateItem(CLV2.AsView.Width, id, cont";
...
RDebugUtils.currentLine=32112656;
 //BA.debugLineNum = 32112656;BA.debugLine="CLV2.AsView.Height = PanelListItem.Height* CLV2";
...
RDebugUtils.currentLine=32112658;
 //BA.debugLineNum = 32112658;BA.debugLine="Dim Type As String = root.Get(\"type\")";
_type = BA.ObjectToString(_root.Get((Object)("type")));
 }else {
RDebugUtils.currentLine=32112660;
 //BA.debugLineNum = 32112660;BA.debugLine="Log(\"Error\" & j.ErrorMessage)";
anywheresoftware.b4a.keywords.Common.Log("Error"+_j._errormessage);
RDebugUtils.currentLine=32112661;
 //BA.debugLineNum = 32112661;BA.debugLine="ProgressDialogHide";
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 };
RDebugUtils.currentLine=32112663;
 //BA.debugLineNum = 32112663;BA.debugLine="j.Release";
_j._release();
RDebugUtils.currentLine=32112666;
 //BA.debugLineNum = 32112666;BA.debugLine="ScrollView1.Height = 100%y - WebViewTest.Height -";
...
RDebugUtils.currentLine=32309248;
 //BA.debugLineNum = 32309248;BA.debugLine="Sub BackArrow_Click";
RDebugUtils.currentLine=32309249;
 //BA.debugLineNum = 32309249;BA.debugLine="Activity.Finish";
...
RDebugUtils.currentLine=32178176;
 //BA.debugLineNum = 32178176;BA.debugLine="Sub BuildingName_Click";
...
RDebugUtils.currentLine=32047104;
 //BA.debugLineNum = 32047104;BA.debugLine="Sub CLV2_ItemClick (Index As Int, Value As Object)";
RDebugUtils.currentLine=32047106;
 //BA.debugLineNum = 32047106;BA.debugLine="idBuilding = Value 'store the value in the proces";
_idbuilding = BA.ObjectToString(_value);
RDebugUtils.currentLine=32047107;
 //BA.debugLineNum = 32047107;BA.debugLine="StartActivity(EducationalDetail)";
...
RDebugUtils.currentLine=31981568;
 //BA.debugLineNum = 31981568;BA.debugLine="Private Sub CreateItem(Width As Int, Title As Stri";
RDebugUtils.currentLine=31981569;
 //BA.debugLineNum = 31981569;BA.debugLine="Dim p As B4XView = xui.CreatePanel(\"\")";
_p = new anywheresoftware.b4a.objects.B4XViewWrapper();
_p = _xui.CreatePanel(processBA,"");
RDebugUtils.currentLine=31981570;
 //BA.debugLineNum = 31981570;BA.debugLine="p.LoadLayout(\"BuildingListTwo\")";
_p.LoadLayout("BuildingListTwo",mostCurrent.activityBA);
RDebugUtils.currentLine=31981571;
 //BA.debugLineNum = 31981571;BA.debugLine="p.SetLayoutAnimated(0, 0, 0, Width, PanelListItem";
_p.SetLayoutAnimated((int) (0),(int) (0),(int) (0),_width,mostCurrent._panellistitem.getHeight());
RDebugUtils.currentLine=31981572;
 //BA.debugLineNum = 31981572;BA.debugLine="Num.Text = Title";
mostCurrent._num.setText(BA.ObjectToCharSequence(_title));
RDebugUtils.currentLine=31981573;
 //BA.debugLineNum = 31981573;BA.debugLine="BuildingName.Text = Content";
mostCurrent._buildingname.setText(BA.ObjectToCharSequence(_content));
RDebugUtils.currentLine=31981574;
 //BA.debugLineNum = 31981574;BA.debugLine="Return p";
...
RDebugUtils.currentLine=32243712;
 //BA.debugLineNum = 32243712;BA.debugLine="Sub PanelListItem_Click";
RDebugUtils.currentLine=32243713;
 //BA.debugLineNum = 32243713;BA.debugLine="Dim item As Int = CLV2.GetItemFromView(Sender)";
...
RDebugUtils.currentLine=32243714;
 //BA.debugLineNum = 32243714;BA.debugLine="Dim p As B4XView";
_p = new anywheresoftware.b4a.objects.B4XViewWrapper();
RDebugUtils.currentLine=32243715;
 //BA.debugLineNum = 32243715;BA.debugLine="p = CLV2.GetPanel(item)";
_p = mostCurrent._clv2._getpanel(_item);
RDebugUtils.currentLine=32243716;
 //BA.debugLineNum = 32243716;BA.debugLine="Dim a As B4XView";
_a = new anywheresoftware.b4a.objects.B4XViewWrapper();
RDebugUtils.currentLine=32243717;
 //BA.debugLineNum = 32243717;BA.debugLine="a = p.GetView(0)";
_a = _p.GetView((int) (0));
RDebugUtils.currentLine=32243719;
 //BA.debugLineNum = 32243719;BA.debugLine="idBuilding = a.GetView(0).GetView(0).Text";
_idbuilding = _a.GetView((int) (0)).GetView((int) (0)).getText();
RDebugUtils.currentLine=32243721;
 //BA.debugLineNum = 32243721;BA.debugLine="nameBuilding = a.GetView(0).GetView(1).Text";
_namebuilding = _a.GetView((int) (0)).GetView((int) (1)).getText();
RDebugUtils.currentLine=32243722;
 //BA.debugLineNum = 32243722;BA.debugLine="StartActivity(EducationalDetail)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._educationaldetail.getObject()));
