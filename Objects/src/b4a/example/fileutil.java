...
public class fileutil extends  android.app.Service{
	public static class fileutil_BR extends android.content.BroadcastReceiver {

		@Override
		public void onReceive(android.content.Context context, android.content.Intent intent) {
            BA.LogInfo("** Receiver (fileutil) OnReceive **");
			android.content.Intent in = new android.content.Intent(context, fileutil.class);
			if (intent != null)
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new anywheresoftware.b4a.ShellBA(this, null, null, "b4a.example", "b4a.example.fileutil");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.fileutil", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
        if (!false && ServiceHelper.StarterHelper.startFromServiceCreate(processBA, false) == false) {
            ...
            BA.LogInfo("*** Service (fileutil) Create ***");
    ...
    private void handleStart(android.content.Intent intent) {
    	BA.LogInfo("** Service (fileutil) Start **");
	...
	public void onDestroy() {
        super.onDestroy();
        BA.LogInfo("** Service (fileutil) Destroy **");
...
RDebugUtils.currentModule="fileutil";
if (Debug.shouldDelegate(processBA, "service_create"))
	return (String) Debug.delegate(processBA, "service_create", null);
RDebugUtils.currentLine=22740992;
 //BA.debugLineNum = 22740992;BA.debugLine="Sub Service_Create";
...
RDebugUtils.currentLine=22872064;
 //BA.debugLineNum = 22872064;BA.debugLine="Sub Service_Destroy";
...
RDebugUtils.currentLine=22806528;
 //BA.debugLineNum = 22806528;BA.debugLine="Sub Service_Start (StartingIntent As Intent)";
RDebugUtils.currentLine=22806530;
 //BA.debugLineNum = 22806530;BA.debugLine="Service.StopAutomaticForeground 'Call this when t";
