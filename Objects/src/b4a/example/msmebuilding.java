...
public class msmebuilding extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.msmebuilding");
...
mostCurrent._webviewtest.LoadUrl("https://gisbuildingkotogadang.herokuapp.com/msme_building.php");
