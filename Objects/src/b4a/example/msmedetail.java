...
public class msmedetail extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.msmedetail");
...
mostCurrent._activity.LoadLayout("MainScrollView",mostCurrent.activityBA);
 //BA.debugLineNum = 53;BA.debugLine="ScrollView1.Panel.LoadLayout(\"MsmeDetail\")";
mostCurrent._scrollview1.getPanel().LoadLayout("MsmeDetail",mostCurrent.activityBA);
 //BA.debugLineNum = 54;BA.debugLine="PanelToolBar.Visible = False";
mostCurrent._paneltoolbar.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 56;BA.debugLine="BackArrow.Visible= True";
mostCurrent._backarrow.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 57;BA.debugLine="BackArrow.SetBackgroundImage(LoadBitmap(File.DirA";
mostCurrent._backarrow.SetBackgroundImageNew((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"back-arrow.png").getObject()));
 //BA.debugLineNum = 58;BA.debugLine="TitleBar.Text=\"Building Detail\"";
mostCurrent._titlebar.setText(BA.ObjectToCharSequence("Building Detail"));
 //BA.debugLineNum = 60;BA.debugLine="TabHost1.AddTab(\"Map\",\"tabMap\")";
mostCurrent._tabhost1.AddTab(mostCurrent.activityBA,"Map","tabMap");
 //BA.debugLineNum = 61;BA.debugLine="TabHost1.AddTab(\"Detail\",\"Msme_tabDetail\")";
mostCurrent._tabhost1.AddTab(mostCurrent.activityBA,"Detail","Msme_tabDetail");
 //BA.debugLineNum = 62;BA.debugLine="TabHost1.AddTab(\"Gallery\",\"tabGallery\")";
...
mostCurrent._ids = mostCurrent._msmebuilding._idbuilding;
...
if (mostCurrent._searchbuilding._namebuilding.length()>0) { 
 //BA.debugLineNum = 72;BA.debugLine="MsmeName.Text = SearchBuilding.nameBuilding";
...
anywheresoftware.b4a.keywords.Common.Log(mostCurrent._ids);
 ...
 //BA.debugLineNum = 77;BA.debugLine="TabHost1.CurrentTab = 1";
...
public static String  _activity_resume() throws Exception{
 ...
 //BA.debugLineNum = 82;BA.debugLine="CLV1.Clear";
mostCurrent._clv1._clear();
 //BA.debugLineNum = 83;BA.debugLine="ProgressDialogShow(\"loading...\")";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,BA.ObjectToCharSequence("loading..."));
 //BA.debugLineNum = 84;BA.debugLine="ExecuteRemoteQuery(\"SELECT D.msme_building_id, D.";
_executeremotequery("SELECT D.msme_building_id, D.facility_id, D.quantity_of_facilities, F.name_of_facility FROM detail_msme_building_facilities As D LEFT JOIN msme_building_facilities As F ON F.facility_id=D.facility_id WHERE D.msme_building_id ='"+mostCurrent._ids+"'","FASILITAS");
 //BA.debugLineNum = 85;BA.debugLine="ExecuteRemoteQuery(\"SELECT M.msme_building_id, M.";
...
anywheresoftware.b4a.objects.B4XViewWrapper _p = null;
 //BA.debugLineNum = 89;BA.debugLine="Private Sub CreateItem(Width As Int, Title As Stri";
 //BA.debugLineNum = 90;BA.debugLine="Dim p As B4XView = xui.CreatePanel(\"\")";
_p = new anywheresoftware.b4a.objects.B4XViewWrapper();
_p = _xui.CreatePanel(processBA,"");
 //BA.debugLineNum = 91;BA.debugLine="p.LoadLayout(\"facility_list\")";
_p.LoadLayout("facility_list",mostCurrent.activityBA);
 //BA.debugLineNum = 92;BA.debugLine="p.SetLayoutAnimated(0, 0, 0, Width, 5%y)";
_p.SetLayoutAnimated((int) (0),(int) (0),(int) (0),_width,anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (5),mostCurrent.activityBA));
 //BA.debugLineNum = 93;BA.debugLine="numfc.Text = Title";
mostCurrent._numfc.setText(BA.ObjectToCharSequence(_title));
 //BA.debugLineNum = 94;BA.debugLine="namefc.Text = Content";
mostCurrent._namefc.setText(BA.ObjectToCharSequence(_content));
 //BA.debugLineNum = 95;BA.debugLine="Return p";
...
public static String  _editbtn_click() throws Exception{
 //BA.debugLineNum = 202;BA.debugLine="Sub editBtn_Click";
 //BA.debugLineNum = 203;BA.debugLine="StartActivity(MsmeEdit)";
...
public static String  _editfacility_click() throws Exception{
 //BA.debugLineNum = 206;BA.debugLine="Sub editFacility_Click";
 //BA.debugLineNum = 207;BA.debugLine="StartActivity(EditBuildingFacility)";
...
mostCurrent._panelbutton = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 28;BA.debugLine="Dim MsmeName As Label";
...
mostCurrent._standingyear = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 30;BA.debugLine="Private BuildingArea As Label";
mostCurrent._buildingarea = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 31;BA.debugLine="Private LandArea As Label";
mostCurrent._landarea = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 32;BA.debugLine="Private ParkingArea As Label";
mostCurrent._parkingarea = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 33;BA.debugLine="Private Electricity As Label";
mostCurrent._electricity = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 34;BA.debugLine="Private Construction As Label";
...
mostCurrent._tabhost1 = new anywheresoftware.b4a.objects.TabHostWrapper();
 //BA.debugLineNum = 42;BA.debugLine="Private TypeOfMsme As Label";
mostCurrent._typeofmsme = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 43;BA.debugLine="Private PanelMap As Panel";
mostCurrent._panelmap = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 44;BA.debugLine="Private btnRoute As Button";
mostCurrent._btnroute = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 45;BA.debugLine="Private WebViewRoute As WebView";
...
_res = "";
 //BA.debugLineNum = 107;BA.debugLine="res = Job.GetString 'menyimpan json dalam bentuk";
...
anywheresoftware.b4a.keywords.Common.Log("Response from server :"+_res);
 //BA.debugLineNum = 109;BA.debugLine="Dim parser As JSONParser 'mengambil data dalam b";
...
case 0: {
 //BA.debugLineNum = 113;BA.debugLine="Dim fasilitas_array As List";
_fasilitas_array = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 114;BA.debugLine="fasilitas_array = parser.NextArray";
_fasilitas_array = _parser.NextArray();
 //BA.debugLineNum = 115;BA.debugLine="For i=0 To fasilitas_array.Size - 1";
{
final int step11 = 1;
final int limit11 = (int) (_fasilitas_array.getSize()-1);
_i = (int) (0) ;
for (;(step11 > 0 && _i <= limit11) || (step11 < 0 && _i >= limit11) ;_i = ((int)(0 + _i + step11))  ) {
 //BA.debugLineNum = 116;BA.debugLine="Dim a As Map";
_a = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 117;BA.debugLine="a = fasilitas_array.Get(i)";
_a.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_fasilitas_array.Get(_i)));
 //BA.debugLineNum = 119;BA.debugLine="Dim content As String = a.Get(\"name_of_facili";
_content = BA.ObjectToString(_a.Get((Object)("name_of_facility")));
 //BA.debugLineNum = 120;BA.debugLine="Dim quantity As Int = a.Get(\"quantity_of_faci";
_quantity = (int)(BA.ObjectToNumber(_a.Get((Object)("quantity_of_facilities"))));
 //BA.debugLineNum = 121;BA.debugLine="CLV1.Add(CreateItem(CLV1.AsView.Width, $\"${qu";
mostCurrent._clv1._add((anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_createitem(mostCurrent._clv1._asview().getWidth(),(""+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_quantity))+""),_content).getObject())),(Object)(""));
 //BA.debugLineNum = 122;BA.debugLine="CLV1.AsView.Height = ListItem.Height*(i+1)";
...
_sv = new anywheresoftware.b4a.objects.ScrollViewWrapper();
 //BA.debugLineNum = 125;BA.debugLine="CLV1.sv.Height = CLV1.AsView.Height";
mostCurrent._clv1._sv.setHeight(mostCurrent._clv1._asview().getHeight());
 //BA.debugLineNum = 126;BA.debugLine="PFacility.Height = LblFacility.Height + LblFac";
mostCurrent._pfacility.setHeight((int) (mostCurrent._lblfacility.getHeight()+mostCurrent._lblfacility.getTop()));
 //BA.debugLineNum = 127;BA.debugLine="PFacility.Height = PFacility.Height + CLV1.sv.";
mostCurrent._pfacility.setHeight((int) (mostCurrent._pfacility.getHeight()+mostCurrent._clv1._sv.getHeight()+mostCurrent._clv1._asview().getTop()));
 //BA.debugLineNum = 128;BA.debugLine="Select TabHost1.CurrentTab";
switch (BA.switchObjectToInt(mostCurrent._tabhost1.getCurrentTab(),(int) (1))) {
case 0: {
 //BA.debugLineNum = 130;BA.debugLine="TabHost1.Height =PFacility.Top+PFacility.Hei";
...
;
 //BA.debugLineNum = 133;BA.debugLine="PanelBuildingList.Height = PanelBuildingList.H";
...
public static String  _lbledit_click() throws Exception{
 ...
 //BA.debugLineNum = 179;BA.debugLine="StartActivity(MsmeEdit)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._msmeedit.getObject()));
...
public static String  _tabhost1_tabchanged() throws Exception{
 //BA.debugLineNum = 182;BA.debugLine="Sub TabHost1_TabChanged";
...
case 0: {
 //BA.debugLineNum = 186;BA.debugLine="WebViewRoute.LoadUrl(\"https://www.google.com/ma";
mostCurrent._webviewroute.LoadUrl("https://www.google.com/maps/@-0.8206655,100.3217247,15z");
 //BA.debugLineNum = 187;BA.debugLine="Msgbox(\"Current tab is \" & TabHost1.CurrentTab,";
anywheresoftware.b4a.keywords.Common.Msgbox(BA.ObjectToCharSequence("Current tab is "+BA.NumberToString(mostCurrent._tabhost1.getCurrentTab())),BA.ObjectToCharSequence(""),mostCurrent.activityBA);
 //BA.debugLineNum = 188;BA.debugLine="Log (\"Button Top :\"&btnRoute.Top)";
anywheresoftware.b4a.keywords.Common.Log("Button Top :"+BA.NumberToString(mostCurrent._btnroute.getTop()));
 //BA.debugLineNum = 189;BA.debugLine="TabHost1.Height = btnRoute.Top + btnRoute.Heigh";
mostCurrent._tabhost1.setHeight((int) (mostCurrent._btnroute.getTop()+mostCurrent._btnroute.getHeight()+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (10),mostCurrent.activityBA)));
 //BA.debugLineNum = 190;BA.debugLine="Log(\"tabHost height: \"&TabHost1.Height)";
anywheresoftware.b4a.keywords.Common.Log("tabHost height: "+BA.NumberToString(mostCurrent._tabhost1.getHeight()));
 //BA.debugLineNum = 191;BA.debugLine="PanelBuildingList.Height = TabHost1.Height + Ta";
mostCurrent._panelbuildinglist.setHeight((int) (mostCurrent._tabhost1.getHeight()+mostCurrent._tabhost1.getTop()));
 //BA.debugLineNum = 192;BA.debugLine="ScrollView1.Panel.Height = PanelBuildingList.He";
mostCurrent._scrollview1.getPanel().setHeight(mostCurrent._panelbuildinglist.getHeight());
 //BA.debugLineNum = 193;BA.debugLine="ScrollView1.Height = ScrollView1.Panel.Height";
mostCurrent._scrollview1.setHeight(mostCurrent._scrollview1.getPanel().getHeight());
 break; }
case 1: {
 break; }
case 2: {
 //BA.debugLineNum = 197;BA.debugLine="Msgbox(\"Current tab is \" & TabHost1.CurrentTab,";
anywheresoftware.b4a.keywords.Common.Msgbox(BA.ObjectToCharSequence("Current tab is "+BA.NumberToString(mostCurrent._tabhost1.getCurrentTab())),BA.ObjectToCharSequence(""),mostCurrent.activityBA);
 break; }
}
;
