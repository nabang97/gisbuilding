...
public class officedetail extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new anywheresoftware.b4a.ShellBA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.officedetail");
...
public anywheresoftware.b4a.objects.PanelWrapper _tabroute = null;
public anywheresoftware.b4a.objects.PanelWrapper _tabdetail = null;
...
public static int _tab_clicked = 0;
public static int _tab_unclicked = 0;
public anywheresoftware.b4a.objects.PanelWrapper _tabgallery = null;
...
RDebugUtils.currentModule="officedetail";
...
RDebugUtils.currentLine=1638402;
 //BA.debugLineNum = 1638402;BA.debugLine="Activity.LoadLayout(\"MainScrollView\")";
mostCurrent._activity.LoadLayout("MainScrollView",mostCurrent.activityBA);
RDebugUtils.currentLine=1638403;
 //BA.debugLineNum = 1638403;BA.debugLine="ScrollView1.Panel.LoadLayout(\"OfficeDetail\")";
mostCurrent._scrollview1.getPanel().LoadLayout("OfficeDetail",mostCurrent.activityBA);
RDebugUtils.currentLine=1638405;
 //BA.debugLineNum = 1638405;BA.debugLine="ScrollView1.Height = 100%y - ScrollView1.Top";
...
RDebugUtils.currentLine=1638406;
 //BA.debugLineNum = 1638406;BA.debugLine="PanelToolBar.Visible = False";
mostCurrent._paneltoolbar.setVisible(anywheresoftware.b4a.keywords.Common.False);
RDebugUtils.currentLine=1638409;
 //BA.debugLineNum = 1638409;BA.debugLine="BackArrow.Visible= True";
mostCurrent._backarrow.setVisible(anywheresoftware.b4a.keywords.Common.True);
RDebugUtils.currentLine=1638410;
 //BA.debugLineNum = 1638410;BA.debugLine="BackArrow.SetBackgroundImage(LoadBitmapSample(Fil";
mostCurrent._backarrow.SetBackgroundImageNew((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmapSample(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"back-arrow.png",anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (5),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (2),mostCurrent.activityBA)).getObject()));
RDebugUtils.currentLine=1638411;
 //BA.debugLineNum = 1638411;BA.debugLine="TitleBar.Text=\"Building Detail\"";
mostCurrent._titlebar.setText(BA.ObjectToCharSequence("Building Detail"));
RDebugUtils.currentLine=1638413;
 //BA.debugLineNum = 1638413;BA.debugLine="Dim bmp1, bmp2 As Bitmap";
...
RDebugUtils.currentLine=1638414;
 //BA.debugLineNum = 1638414;BA.debugLine="bmp1 = LoadBitmap(File.DirAssets, \"home.png\")";
_bmp1 = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"home.png");
RDebugUtils.currentLine=1638415;
 //BA.debugLineNum = 1638415;BA.debugLine="TabHost1.AddTabWithIcon(\"\",LoadBitmap(File.DirAss";
mostCurrent._tabhost1.AddTabWithIcon(mostCurrent.activityBA,"",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"map-marker-blue.png").getObject()),(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"map-marker-blue.png").getObject()),"tabMap");
RDebugUtils.currentLine=1638416;
 //BA.debugLineNum = 1638416;BA.debugLine="TabHost1.AddTab( \"Detail\",\"Office_tabDetail\")";
mostCurrent._tabhost1.AddTab(mostCurrent.activityBA,"Detail","Office_tabDetail");
RDebugUtils.currentLine=1638417;
 //BA.debugLineNum = 1638417;BA.debugLine="TabHost1.AddTab( \"Gallery\", \"tabGallery\")";
mostCurrent._tabhost1.AddTab(mostCurrent.activityBA,"Gallery","tabGallery");
RDebugUtils.currentLine=1638419;
 //BA.debugLineNum = 1638419;BA.debugLine="TabManager.setTabHeight(TabHost1,10%x)";
mostCurrent._tabmanager.setTabHeight((android.widget.TabHost)(mostCurrent._tabhost1.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (10),mostCurrent.activityBA));
RDebugUtils.currentLine=1638420;
 //BA.debugLineNum = 1638420;BA.debugLine="TabManager.setTabGradientDrawable(TabHost1,\"TOP_B";
mostCurrent._tabmanager.setTabGradientDrawable((android.widget.TabHost)(mostCurrent._tabhost1.getObject()),"TOP_BOTTOM",anywheresoftware.b4a.keywords.Common.Colors.Transparent,anywheresoftware.b4a.keywords.Common.Colors.Transparent,(float) (0));
RDebugUtils.currentLine=1638421;
 //BA.debugLineNum = 1638421;BA.debugLine="TabManager.setTabContentViewPadding(TabHost1,0,20";
mostCurrent._tabmanager.setTabContentViewPadding((android.widget.TabHost)(mostCurrent._tabhost1.getObject()),(int) (0),(int) (20),(int) (0),(int) (0));
RDebugUtils.currentLine=1638424;
 //BA.debugLineNum = 1638424;BA.debugLine="FunctionAll.CheckBuilding_id(OfficeBuilding.idBui";
...
RDebugUtils.currentLine=1638425;
 //BA.debugLineNum = 1638425;BA.debugLine="ids = FunctionAll.ids";
mostCurrent._ids = mostCurrent._functionall._ids;
RDebugUtils.currentLine=1638426;
 //BA.debugLineNum = 1638426;BA.debugLine="Log(\"DARI SINI\"&ids)";
anywheresoftware.b4a.keywords.Common.Log("DARI SINI"+mostCurrent._ids);
RDebugUtils.currentLine=1638428;
 //BA.debugLineNum = 1638428;BA.debugLine="TabHost1.CurrentTab = 1";
mostCurrent._tabhost1.setCurrentTab((int) (1));
RDebugUtils.currentLine=1638429;
 //BA.debugLineNum = 1638429;BA.debugLine="AddPicture.Initialize(\"AddPicture\")";
mostCurrent._addpicture.Initialize(mostCurrent.activityBA,"AddPicture");
RDebugUtils.currentLine=1638432;
 //BA.debugLineNum = 1638432;BA.debugLine="tab_clicked=Colors.White";
_tab_clicked = anywheresoftware.b4a.keywords.Common.Colors.White;
RDebugUtils.currentLine=1638433;
 //BA.debugLineNum = 1638433;BA.debugLine="tab_unclicked=Colors.ARGB(255,0,111,196)";
_tab_unclicked = anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (255),(int) (0),(int) (111),(int) (196));
RDebugUtils.currentLine=1638434;
 //BA.debugLineNum = 1638434;BA.debugLine="FunctionAll.setCornerRadii(tabRoute,25,25,0,0,0,0";
mostCurrent._functionall._setcornerradii(mostCurrent.activityBA,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(mostCurrent._tabroute.getObject())),(float) (25),(float) (25),(float) (0),(float) (0),(float) (0),(float) (0),(float) (25),(float) (25));
RDebugUtils.currentLine=1638435;
 //BA.debugLineNum = 1638435;BA.debugLine="FunctionAll.setCornerRadii(tabRoute,25,25,0,0,0,0";
mostCurrent._functionall._setcornerradii(mostCurrent.activityBA,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(mostCurrent._tabroute.getObject())),(float) (25),(float) (25),(float) (0),(float) (0),(float) (0),(float) (0),(float) (25),(float) (25));
...
RDebugUtils.currentLine=1769473;
 //BA.debugLineNum = 1769473;BA.debugLine="CallSub(Starter, \"ActivityIsPaused\")";
...
RDebugUtils.currentLine=1703939;
 //BA.debugLineNum = 1703939;BA.debugLine="CLV1.Clear";
mostCurrent._clv1._clear();
RDebugUtils.currentLine=1703940;
 //BA.debugLineNum = 1703940;BA.debugLine="ProgressDialogShow(\"Loading...\")";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,BA.ObjectToCharSequence("Loading..."));
RDebugUtils.currentLine=1703942;
 //BA.debugLineNum = 1703942;BA.debugLine="If TabHost1.CurrentTab == 2 Then";
if (mostCurrent._tabhost1.getCurrentTab()==2) { 
RDebugUtils.currentLine=1703943;
 //BA.debugLineNum = 1703943;BA.debugLine="clv.Clear";
mostCurrent._clv._clear();
RDebugUtils.currentLine=1703944;
 //BA.debugLineNum = 1703944;BA.debugLine="ExecuteRemoteQuery(\"SELECT photo_url, upload_dat";
_executeremotequery("SELECT photo_url, upload_date FROM office_building_gallery WHERE office_building_id='"+mostCurrent._ids+"'","Download");
 }else {
RDebugUtils.currentLine=1703946;
 //BA.debugLineNum = 1703946;BA.debugLine="ExecuteRemoteQuery(\"SELECT D.office_building_id,";
...
RDebugUtils.currentLine=1703947;
 //BA.debugLineNum = 1703947;BA.debugLine="ExecuteRemoteQuery(\"SELECT O.office_building_id,";
...
RDebugUtils.currentLine=1900544;
 //BA.debugLineNum = 1900544;BA.debugLine="Sub ExecuteRemoteQuery(Query As String, JobName As";
...
RDebugUtils.currentLine=1900547;
 //BA.debugLineNum = 1900547;BA.debugLine="Job.PostString(\"\"&Main.Server&\"mobile/json.php\",";
...
RDebugUtils.currentLine=2031616;
 //BA.debugLineNum = 2031616;BA.debugLine="Sub AddPicture_Click";
RDebugUtils.currentLine=2031617;
 //BA.debugLineNum = 2031617;BA.debugLine="ToastMessageShow(\"Add photo\",True)";
...
RDebugUtils.currentLine=2031618;
 //BA.debugLineNum = 2031618;BA.debugLine="StartActivity(AddPhoto)";
...
RDebugUtils.currentLine=2097152;
 //BA.debugLineNum = 2097152;BA.debugLine="Sub BackArrow_Click";
...
RDebugUtils.currentLine=1835008;
 //BA.debugLineNum = 1835008;BA.debugLine="Private Sub CreateItem(Width As Int, Title As Stri";
RDebugUtils.currentLine=1835009;
 //BA.debugLineNum = 1835009;BA.debugLine="Dim p As B4XView = xui.CreatePanel(\"\")";
_p = new anywheresoftware.b4a.objects.B4XViewWrapper();
_p = _xui.CreatePanel(processBA,"");
RDebugUtils.currentLine=1835010;
 //BA.debugLineNum = 1835010;BA.debugLine="p.LoadLayout(\"facility_list\")";
_p.LoadLayout("facility_list",mostCurrent.activityBA);
RDebugUtils.currentLine=1835011;
 //BA.debugLineNum = 1835011;BA.debugLine="p.SetLayoutAnimated(0, 0, 0, Width, 5%y)";
...
RDebugUtils.currentLine=1835012;
 //BA.debugLineNum = 1835012;BA.debugLine="numfc.Text = Title";
mostCurrent._numfc.setText(BA.ObjectToCharSequence(_title));
RDebugUtils.currentLine=1835013;
 //BA.debugLineNum = 1835013;BA.debugLine="namefc.Text = Content";
mostCurrent._namefc.setText(BA.ObjectToCharSequence(_content));
RDebugUtils.currentLine=1835014;
 //BA.debugLineNum = 1835014;BA.debugLine="Return p";
...
RDebugUtils.currentLine=2228224;
 //BA.debugLineNum = 2228224;BA.debugLine="Sub editBtn_Click";
RDebugUtils.currentLine=2228225;
 //BA.debugLineNum = 2228225;BA.debugLine="StartActivity(OfficeEdit)";
...
RDebugUtils.currentLine=2293760;
 //BA.debugLineNum = 2293760;BA.debugLine="Sub editFacility_Click";
RDebugUtils.currentLine=2293761;
 //BA.debugLineNum = 2293761;BA.debugLine="StartActivity(EditBuildingFacility)";
...
RDebugUtils.currentLine=2359296;
 //BA.debugLineNum = 2359296;BA.debugLine="Sub ImageView1_Click";
RDebugUtils.currentLine=2359297;
 //BA.debugLineNum = 2359297;BA.debugLine="Dim iv As ImageView";
_iv = new anywheresoftware.b4a.objects.ImageViewWrapper();
RDebugUtils.currentLine=2359298;
 //BA.debugLineNum = 2359298;BA.debugLine="iv = Sender";
_iv.setObject((android.widget.ImageView)(anywheresoftware.b4a.keywords.Common.Sender(mostCurrent.activityBA)));
RDebugUtils.currentLine=2359299;
 //BA.debugLineNum = 2359299;BA.debugLine="If iv.Background Is BitmapDrawable Then";
if (_iv.getBackground() instanceof android.graphics.drawable.BitmapDrawable) { 
RDebugUtils.currentLine=2359301;
 //BA.debugLineNum = 2359301;BA.debugLine="Dim bd As BitmapDrawable";
_bd = new anywheresoftware.b4a.objects.drawable.BitmapDrawable();
RDebugUtils.currentLine=2359302;
 //BA.debugLineNum = 2359302;BA.debugLine="bd = iv.Background";
_bd.setObject((android.graphics.drawable.BitmapDrawable)(_iv.getBackground()));
RDebugUtils.currentLine=2359303;
 //BA.debugLineNum = 2359303;BA.debugLine="Dim bmp As Bitmap";
_bmp = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
RDebugUtils.currentLine=2359304;
 //BA.debugLineNum = 2359304;BA.debugLine="bmp = bd.Bitmap";
_bmp.setObject((android.graphics.Bitmap)(_bd.getBitmap()));
RDebugUtils.currentLine=2359305;
 //BA.debugLineNum = 2359305;BA.debugLine="CallSubDelayed2(ShowImage, \"Show\", bmp)";
...
RDebugUtils.currentLine=1966081;
 //BA.debugLineNum = 1966081;BA.debugLine="If Job.Success Then";
if (_job._success) { 
RDebugUtils.currentLine=1966082;
 //BA.debugLineNum = 1966082;BA.debugLine="Dim res As String";
_res = "";
RDebugUtils.currentLine=1966083;
 //BA.debugLineNum = 1966083;BA.debugLine="res = Job.GetString 'menyimpan json dalam bentuk";
_res = _job._getstring();
RDebugUtils.currentLine=1966084;
 //BA.debugLineNum = 1966084;BA.debugLine="Log(\"Response from server :\"& res)";
anywheresoftware.b4a.keywords.Common.Log("Response from server :"+_res);
RDebugUtils.currentLine=1966085;
 //BA.debugLineNum = 1966085;BA.debugLine="Dim parser As JSONParser 'mengambil data dalam b";
_parser = new anywheresoftware.b4a.objects.collections.JSONParser();
RDebugUtils.currentLine=1966086;
 //BA.debugLineNum = 1966086;BA.debugLine="parser.Initialize(res)";
_parser.Initialize(_res);
RDebugUtils.currentLine=1966087;
 //BA.debugLineNum = 1966087;BA.debugLine="Select Job.JobName";
switch (BA.switchObjectToInt(_job._jobname,"Download","FASILITAS","DATA")) {
case 0: {
RDebugUtils.currentLine=1966090;
 //BA.debugLineNum = 1966090;BA.debugLine="Dim agn As List";
_agn = new anywheresoftware.b4a.objects.collections.List();
RDebugUtils.currentLine=1966091;
 //BA.debugLineNum = 1966091;BA.debugLine="agn=parser.NextArray";
_agn = _parser.NextArray();
RDebugUtils.currentLine=1966092;
 //BA.debugLineNum = 1966092;BA.debugLine="If agn.Size - 1 < 0 Then";
if (_agn.getSize()-1<0) { 
RDebugUtils.currentLine=1966093;
 //BA.debugLineNum = 1966093;BA.debugLine="Log(agn.Size)";
anywheresoftware.b4a.keywords.Common.Log(BA.NumberToString(_agn.getSize()));
RDebugUtils.currentLine=1966094;
 //BA.debugLineNum = 1966094;BA.debugLine="Dim NotFound As Label";
_notfound = new anywheresoftware.b4a.objects.LabelWrapper();
RDebugUtils.currentLine=1966095;
 //BA.debugLineNum = 1966095;BA.debugLine="NotFound.Initialize(\"\")";
_notfound.Initialize(mostCurrent.activityBA,"");
RDebugUtils.currentLine=1966096;
 //BA.debugLineNum = 1966096;BA.debugLine="PanelGallery.Color= Colors.White";
mostCurrent._panelgallery.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
RDebugUtils.currentLine=1966097;
 //BA.debugLineNum = 1966097;BA.debugLine="PanelGallery.AddView(NotFound,0,0,100%x,70%y)";
...
RDebugUtils.currentLine=1966098;
 //BA.debugLineNum = 1966098;BA.debugLine="NotFound.Text = \"Picture doesn't exist\"";
_notfound.setText(BA.ObjectToCharSequence("Picture doesn't exist"));
RDebugUtils.currentLine=1966099;
 //BA.debugLineNum = 1966099;BA.debugLine="NotFound.TextSize = 15";
_notfound.setTextSize((float) (15));
RDebugUtils.currentLine=1966100;
 //BA.debugLineNum = 1966100;BA.debugLine="NotFound.Gravity = Gravity.CENTER";
_notfound.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
RDebugUtils.currentLine=1966101;
 //BA.debugLineNum = 1966101;BA.debugLine="PanelGallery.Height = NotFound.Height";
mostCurrent._panelgallery.setHeight(_notfound.getHeight());
RDebugUtils.currentLine=1966103;
 //BA.debugLineNum = 1966103;BA.debugLine="Msgbox(\"Galery Foto tidak ditemukan\", \"Pering";
...
RDebugUtils.currentLine=1966105;
 //BA.debugLineNum = 1966105;BA.debugLine="ScrollImage.Initialize(100%y)";
...
RDebugUtils.currentLine=1966106;
 //BA.debugLineNum = 1966106;BA.debugLine="PanelGallery.AddView(ScrollImage,0,0,100%x,10";
...
RDebugUtils.currentLine=1966107;
 //BA.debugLineNum = 1966107;BA.debugLine="ScrollImage.Panel.LoadLayout(\"LoaderImage\")";
mostCurrent._scrollimage.getPanel().LoadLayout("LoaderImage",mostCurrent.activityBA);
RDebugUtils.currentLine=1966108;
 //BA.debugLineNum = 1966108;BA.debugLine="For i=0 To agn.Size-1";
{
final int step26 = 1;
final int limit26 = (int) (_agn.getSize()-1);
_i = (int) (0) ;
for (;(step26 > 0 && _i <= limit26) || (step26 < 0 && _i >= limit26) ;_i = ((int)(0 + _i + step26))  ) {
RDebugUtils.currentLine=1966109;
 //BA.debugLineNum = 1966109;BA.debugLine="Dim w As Map";
_w = new anywheresoftware.b4a.objects.collections.Map();
RDebugUtils.currentLine=1966110;
 //BA.debugLineNum = 1966110;BA.debugLine="w=agn.Get(i)";
_w.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_agn.Get(_i)));
RDebugUtils.currentLine=1966111;
 //BA.debugLineNum = 1966111;BA.debugLine="Dim image = w.Get(\"photo_url\") As String";
_image = BA.ObjectToString(_w.Get((Object)("photo_url")));
RDebugUtils.currentLine=1966112;
 //BA.debugLineNum = 1966112;BA.debugLine="Dim gambar = \"\"&Main.Server&\"Files/Office/im";
_gambar = ""+mostCurrent._main._server+"Files/Office/img/"+_image;
RDebugUtils.currentLine=1966113;
 //BA.debugLineNum = 1966113;BA.debugLine="Dim m As Map";
_m = new anywheresoftware.b4a.objects.collections.Map();
RDebugUtils.currentLine=1966114;
 //BA.debugLineNum = 1966114;BA.debugLine="m.Initialize";
_m.Initialize();
RDebugUtils.currentLine=1966115;
 //BA.debugLineNum = 1966115;BA.debugLine="Dim p As Panel";
_p = new anywheresoftware.b4a.objects.PanelWrapper();
RDebugUtils.currentLine=1966116;
 //BA.debugLineNum = 1966116;BA.debugLine="p.Initialize(\"\")";
_p.Initialize(mostCurrent.activityBA,"");
RDebugUtils.currentLine=1966117;
 //BA.debugLineNum = 1966117;BA.debugLine="p.SetLayout(0,0,100%x,20%y)";
...
RDebugUtils.currentLine=1966118;
 //BA.debugLineNum = 1966118;BA.debugLine="p.LoadLayout(\"listitem-image\")";
_p.LoadLayout("listitem-image",mostCurrent.activityBA);
RDebugUtils.currentLine=1966119;
 //BA.debugLineNum = 1966119;BA.debugLine="clv.Add(p,m)";
...
RDebugUtils.currentLine=1966120;
 //BA.debugLineNum = 1966120;BA.debugLine="m.Put(ImageView1, gambar)";
_m.Put((Object)(mostCurrent._imageview1.getObject()),(Object)(_gambar));
RDebugUtils.currentLine=1966121;
 //BA.debugLineNum = 1966121;BA.debugLine="Log (gambar)";
anywheresoftware.b4a.keywords.Common.Log(_gambar);
RDebugUtils.currentLine=1966122;
 //BA.debugLineNum = 1966122;BA.debugLine="CallSubDelayed2(Starter, \"Download\", m)";
...
RDebugUtils.currentLine=1966124;
 //BA.debugLineNum = 1966124;BA.debugLine="ScrollView1.Height = 100%y - ScrollView1.Top";
mostCurrent._scrollview1.setHeight((int) (anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA)-mostCurrent._scrollview1.getTop()));
RDebugUtils.currentLine=1966125;
 //BA.debugLineNum = 1966125;BA.debugLine="ScrollImage.Panel.Height = (ImageView1.Height";
...
RDebugUtils.currentLine=1966126;
 //BA.debugLineNum = 1966126;BA.debugLine="ScrollImage.Height = 70%y";
...
RDebugUtils.currentLine=1966127;
 //BA.debugLineNum = 1966127;BA.debugLine="PanelGallery.Height = ScrollImage.Height";
mostCurrent._panelgallery.setHeight(mostCurrent._scrollimage.getHeight());
RDebugUtils.currentLine=1966128;
 //BA.debugLineNum = 1966128;BA.debugLine="TabHost1.Height = ScrollImage.Height";
mostCurrent._tabhost1.setHeight(mostCurrent._scrollimage.getHeight());
 };
RDebugUtils.currentLine=1966130;
 //BA.debugLineNum = 1966130;BA.debugLine="AddPicture.RemoveView";
mostCurrent._addpicture.RemoveView();
RDebugUtils.currentLine=1966131;
 //BA.debugLineNum = 1966131;BA.debugLine="PanelBuildingList.AddView(AddPicture,0, TabHos";
...
RDebugUtils.currentLine=1966132;
 //BA.debugLineNum = 1966132;BA.debugLine="PanelBuildingList.Height = AddPicture.Top + Ad";
...
RDebugUtils.currentLine=1966133;
 //BA.debugLineNum = 1966133;BA.debugLine="ScrollView1.Panel.Height = PanelBuildingList.H";
mostCurrent._scrollview1.getPanel().setHeight(mostCurrent._panelbuildinglist.getHeight());
RDebugUtils.currentLine=1966134;
 //BA.debugLineNum = 1966134;BA.debugLine="ProgressDialogHide";
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
RDebugUtils.currentLine=1966135;
 //BA.debugLineNum = 1966135;BA.debugLine="FunctionAll.setCornerRadii(tabRoute,25,25,0,0,0";
mostCurrent._functionall._setcornerradii(mostCurrent.activityBA,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(mostCurrent._tabroute.getObject())),(float) (25),(float) (25),(float) (0),(float) (0),(float) (0),(float) (0),(float) (25),(float) (25));
RDebugUtils.currentLine=1966136;
 //BA.debugLineNum = 1966136;BA.debugLine="FunctionAll.setCornerRadii(tabGallery,0,0,25,2";
mostCurrent._functionall._setcornerradii(mostCurrent.activityBA,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(mostCurrent._tabgallery.getObject())),(float) (0),(float) (0),(float) (25),(float) (25),(float) (25),(float) (25),(float) (0),(float) (0));
 break; }
case 1: {
RDebugUtils.currentLine=1966139;
 //BA.debugLineNum = 1966139;BA.debugLine="Dim fasilitas_array As List";
_fasilitas_array = new anywheresoftware.b4a.objects.collections.List();
RDebugUtils.currentLine=1966140;
 //BA.debugLineNum = 1966140;BA.debugLine="fasilitas_array = parser.NextArray";
_fasilitas_array = _parser.NextArray();
RDebugUtils.currentLine=1966141;
 //BA.debugLineNum = 1966141;BA.debugLine="If fasilitas_array.Size-1 < 0 Then";
if (_fasilitas_array.getSize()-1<0) { 
RDebugUtils.currentLine=1966142;
 //BA.debugLineNum = 1966142;BA.debugLine="CLV1.AsView.Visible= False";
mostCurrent._clv1._asview().setVisible(anywheresoftware.b4a.keywords.Common.False);
RDebugUtils.currentLine=1966143;
 //BA.debugLineNum = 1966143;BA.debugLine="Dim NotExist As Label";
_notexist = new anywheresoftware.b4a.objects.LabelWrapper();
RDebugUtils.currentLine=1966144;
 //BA.debugLineNum = 1966144;BA.debugLine="NotExist.Initialize(\"\")";
_notexist.Initialize(mostCurrent.activityBA,"");
RDebugUtils.currentLine=1966145;
 //BA.debugLineNum = 1966145;BA.debugLine="PFacility.AddView(NotExist,LblFacility.Left,0";
...
RDebugUtils.currentLine=1966154;
 //BA.debugLineNum = 1966154;BA.debugLine="For i=0 To fasilitas_array.Size - 1";
{
final int step71 = 1;
...
RDebugUtils.currentLine=1966161;
 //BA.debugLineNum = 1966161;BA.debugLine="CLV1.AsView.Height = ListItem.Height*(i+1)";
mostCurrent._clv1._asview().setHeight((int) (mostCurrent._listitem.getHeight()*(_i+1)));
 }
};
RDebugUtils.currentLine=1966163;
 //BA.debugLineNum = 1966163;BA.debugLine="CLV1.sv.Height = CLV1.AsView.Height";
mostCurrent._clv1._sv.setHeight(mostCurrent._clv1._asview().getHeight());
RDebugUtils.currentLine=1966164;
 //BA.debugLineNum = 1966164;BA.debugLine="PFacility.Height = LblFacility.Height + LblFa";
...
RDebugUtils.currentLine=1966165;
 //BA.debugLineNum = 1966165;BA.debugLine="PFacility.Height = PFacility.Height + CLV1.sv";
...
RDebugUtils.currentLine=1966166;
 //BA.debugLineNum = 1966166;BA.debugLine="If TabHost1.CurrentTab = 1 Then";
if (mostCurrent._tabhost1.getCurrentTab()==1) { 
RDebugUtils.currentLine=1966167;
 //BA.debugLineNum = 1966167;BA.debugLine="TabHost1.Height = PFacility.Top+PFacility.H";
...
RDebugUtils.currentLine=1966170;
 //BA.debugLineNum = 1966170;BA.debugLine="PanelBuildingList.Height = TabHost1.Height + T";
...
RDebugUtils.currentLine=1966171;
 //BA.debugLineNum = 1966171;BA.debugLine="ScrollView1.Panel.Height = PanelBuildingList.H";
mostCurrent._scrollview1.getPanel().setHeight(mostCurrent._panelbuildinglist.getHeight());
RDebugUtils.currentLine=1966172;
 //BA.debugLineNum = 1966172;BA.debugLine="ScrollView1.Height = ScrollView1.Panel.Height";
mostCurrent._scrollview1.setHeight(mostCurrent._scrollview1.getPanel().getHeight());
RDebugUtils.currentLine=1966173;
 //BA.debugLineNum = 1966173;BA.debugLine="Log(content)";
anywheresoftware.b4a.keywords.Common.Log(_content);
RDebugUtils.currentLine=1966174;
 //BA.debugLineNum = 1966174;BA.debugLine="ProgressDialogHide";
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
RDebugUtils.currentLine=1966175;
 //BA.debugLineNum = 1966175;BA.debugLine="FunctionAll.setCornerRadii(tabRoute,25,25,0,0,";
mostCurrent._functionall._setcornerradii(mostCurrent.activityBA,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(mostCurrent._tabroute.getObject())),(float) (25),(float) (25),(float) (0),(float) (0),(float) (0),(float) (0),(float) (25),(float) (25));
RDebugUtils.currentLine=1966176;
 //BA.debugLineNum = 1966176;BA.debugLine="FunctionAll.setCornerRadii(tabGallery,0,0,25,2";
mostCurrent._functionall._setcornerradii(mostCurrent.activityBA,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(mostCurrent._tabgallery.getObject())),(float) (0),(float) (0),(float) (25),(float) (25),(float) (25),(float) (25),(float) (0),(float) (0));
 break; }
case 2: {
RDebugUtils.currentLine=1966179;
 //BA.debugLineNum = 1966179;BA.debugLine="Dim data_array As List";
_data_array = new anywheresoftware.b4a.objects.collections.List();
RDebugUtils.currentLine=1966180;
 //BA.debugLineNum = 1966180;BA.debugLine="data_array = parser.NextArray";
_data_array = _parser.NextArray();
RDebugUtils.currentLine=1966181;
 //BA.debugLineNum = 1966181;BA.debugLine="For i=0 To data_array.Size -1";
{
final int step96 = 1;
final int limit96 = (int) (_data_array.getSize()-1);
_i = (int) (0) ;
for (;(step96 > 0 && _i <= limit96) || (step96 < 0 && _i >= limit96) ;_i = ((int)(0 + _i + step96))  ) {
RDebugUtils.currentLine=1966182;
 //BA.debugLineNum = 1966182;BA.debugLine="Dim a As Map";
_a = new anywheresoftware.b4a.objects.collections.Map();
RDebugUtils.currentLine=1966183;
 //BA.debugLineNum = 1966183;BA.debugLine="a = data_array.Get(i)";
_a.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(_data_array.Get(_i)));
RDebugUtils.currentLine=1966184;
 //BA.debugLineNum = 1966184;BA.debugLine="lat = a.Get(\"latitude\")";
_lat = BA.ObjectToString(_a.Get((Object)("latitude")));
RDebugUtils.currentLine=1966185;
 //BA.debugLineNum = 1966185;BA.debugLine="lng = a.Get(\"longitude\")";
_lng = BA.ObjectToString(_a.Get((Object)("longitude")));
RDebugUtils.currentLine=1966186;
 //BA.debugLineNum = 1966186;BA.debugLine="Log(lat)";
anywheresoftware.b4a.keywords.Common.Log(_lat);
RDebugUtils.currentLine=1966187;
 //BA.debugLineNum = 1966187;BA.debugLine="Log(lng)";
anywheresoftware.b4a.keywords.Common.Log(_lng);
RDebugUtils.currentLine=1966188;
 //BA.debugLineNum = 1966188;BA.debugLine="OfficeName.Text = a.Get(\"name_of_office_build";
...
RDebugUtils.currentLine=1966195;
 //BA.debugLineNum = 1966195;BA.debugLine="Construction.Text = a.Get(\"constr\")";
mostCurrent._construction.setText(BA.ObjectToCharSequence(_a.Get((Object)("constr"))));
 }
};
RDebugUtils.currentLine=1966197;
 //BA.debugLineNum = 1966197;BA.debugLine="FunctionAll.setCornerRadii(tabRoute,25,25,0,0,";
mostCurrent._functionall._setcornerradii(mostCurrent.activityBA,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(mostCurrent._tabroute.getObject())),(float) (25),(float) (25),(float) (0),(float) (0),(float) (0),(float) (0),(float) (25),(float) (25));
RDebugUtils.currentLine=1966198;
 //BA.debugLineNum = 1966198;BA.debugLine="FunctionAll.setCornerRadii(tabGallery,0,0,25,2";
mostCurrent._functionall._setcornerradii(mostCurrent.activityBA,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(mostCurrent._tabgallery.getObject())),(float) (0),(float) (0),(float) (25),(float) (25),(float) (25),(float) (25),(float) (0),(float) (0));
 break; }
}
;
...
RDebugUtils.currentLine=1966201;
 //BA.debugLineNum = 1966201;BA.debugLine="Job.Release";
_job._release();
RDebugUtils.currentLine=1966202;
 //BA.debugLineNum = 1966202;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=2162688;
 //BA.debugLineNum = 2162688;BA.debugLine="Sub TabHost1_TabChanged";
RDebugUtils.currentLine=2162690;
 //BA.debugLineNum = 2162690;BA.debugLine="Select TabHost1.CurrentTab";
switch (BA.switchObjectToInt(mostCurrent._tabhost1.getCurrentTab(),(int) (0),(int) (1),(int) (2))) {
case 0: {
RDebugUtils.currentLine=2162693;
 //BA.debugLineNum = 2162693;BA.debugLine="tabRoute.Color = tab_clicked";
mostCurrent._tabroute.setColor(_tab_clicked);
RDebugUtils.currentLine=2162694;
 //BA.debugLineNum = 2162694;BA.debugLine="tabDetail.Color= tab_unclicked";
mostCurrent._tabdetail.setColor(_tab_unclicked);
RDebugUtils.currentLine=2162695;
 //BA.debugLineNum = 2162695;BA.debugLine="tabGallery.Color= tab_unclicked";
mostCurrent._tabgallery.setColor(_tab_unclicked);
RDebugUtils.currentLine=2162696;
 //BA.debugLineNum = 2162696;BA.debugLine="FunctionAll.setCornerRadii(tabRoute,25,25,0,0,0";
mostCurrent._functionall._setcornerradii(mostCurrent.activityBA,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(mostCurrent._tabroute.getObject())),(float) (25),(float) (25),(float) (0),(float) (0),(float) (0),(float) (0),(float) (25),(float) (25));
RDebugUtils.currentLine=2162697;
 //BA.debugLineNum = 2162697;BA.debugLine="FunctionAll.setCornerRadii(tabGallery,0,0,25,25";
mostCurrent._functionall._setcornerradii(mostCurrent.activityBA,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(mostCurrent._tabgallery.getObject())),(float) (0),(float) (0),(float) (25),(float) (25),(float) (25),(float) (25),(float) (0),(float) (0));
RDebugUtils.currentLine=2162698;
 //BA.debugLineNum = 2162698;BA.debugLine="WebViewRoute.LoadUrl(Main.Server&\"Office/Route.";
mostCurrent._webviewroute.LoadUrl(mostCurrent._main._server+"Office/Route.php?lat="+mostCurrent._main._lbllat+"&lng="+mostCurrent._main._lbllon+"&latd="+_lat+"&lngd="+_lng);
RDebugUtils.currentLine=2162699;
 //BA.debugLineNum = 2162699;BA.debugLine="Msgbox(\"Current tab is \" & TabHost1.CurrentTab,";
...
RDebugUtils.currentLine=2162700;
 //BA.debugLineNum = 2162700;BA.debugLine="Log (\"Button Top :\"&btnRoute.Top)";
...
RDebugUtils.currentLine=2162701;
 //BA.debugLineNum = 2162701;BA.debugLine="TabHost1.Height = btnRoute.Top + btnRoute.Heigh";
...
RDebugUtils.currentLine=2162702;
 //BA.debugLineNum = 2162702;BA.debugLine="Log(\"tabHost height: \"&TabHost1.Height)";
...
RDebugUtils.currentLine=2162703;
 //BA.debugLineNum = 2162703;BA.debugLine="AddPicture.Visible=False";
mostCurrent._addpicture.setVisible(anywheresoftware.b4a.keywords.Common.False);
RDebugUtils.currentLine=2162704;
 //BA.debugLineNum = 2162704;BA.debugLine="PanelBuildingList.Height = TabHost1.Height + Ta";
...
RDebugUtils.currentLine=2162705;
 //BA.debugLineNum = 2162705;BA.debugLine="ScrollView1.Panel.Height = PanelBuildingList.He";
mostCurrent._scrollview1.getPanel().setHeight(mostCurrent._panelbuildinglist.getHeight());
 break; }
case 1: {
RDebugUtils.currentLine=2162708;
 //BA.debugLineNum = 2162708;BA.debugLine="tabRoute.Color = tab_unclicked";
mostCurrent._tabroute.setColor(_tab_unclicked);
RDebugUtils.currentLine=2162709;
 //BA.debugLineNum = 2162709;BA.debugLine="tabDetail.Color= tab_clicked";
mostCurrent._tabdetail.setColor(_tab_clicked);
RDebugUtils.currentLine=2162710;
 //BA.debugLineNum = 2162710;BA.debugLine="tabGallery.Color = tab_unclicked";
mostCurrent._tabgallery.setColor(_tab_unclicked);
RDebugUtils.currentLine=2162711;
 //BA.debugLineNum = 2162711;BA.debugLine="FunctionAll.setCornerRadii(tabRoute,25,25,0,0,0";
mostCurrent._functionall._setcornerradii(mostCurrent.activityBA,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(mostCurrent._tabroute.getObject())),(float) (25),(float) (25),(float) (0),(float) (0),(float) (0),(float) (0),(float) (25),(float) (25));
RDebugUtils.currentLine=2162712;
 //BA.debugLineNum = 2162712;BA.debugLine="FunctionAll.setCornerRadii(tabGallery,0,0,25,25";
mostCurrent._functionall._setcornerradii(mostCurrent.activityBA,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(mostCurrent._tabgallery.getObject())),(float) (0),(float) (0),(float) (25),(float) (25),(float) (25),(float) (25),(float) (0),(float) (0));
RDebugUtils.currentLine=2162713;
 //BA.debugLineNum = 2162713;BA.debugLine="CLV1.Clear";
mostCurrent._clv1._clear();
RDebugUtils.currentLine=2162714;
 //BA.debugLineNum = 2162714;BA.debugLine="AddPicture.Visible=False";
mostCurrent._addpicture.setVisible(anywheresoftware.b4a.keywords.Common.False);
RDebugUtils.currentLine=2162715;
 //BA.debugLineNum = 2162715;BA.debugLine="ProgressDialogShow(\"Loading...\")";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,BA.ObjectToCharSequence("Loading..."));
RDebugUtils.currentLine=2162716;
 //BA.debugLineNum = 2162716;BA.debugLine="ExecuteRemoteQuery(\"SELECT D.office_building_id";
_executeremotequery("SELECT D.office_building_id, D.facility_id, D.quantity_of_facilities, F.name_of_facility FROM detail_office_building_facilities As D LEFT JOIN office_building_facilities As F ON F.facility_id=D.facility_id WHERE D.office_building_id ='"+mostCurrent._ids+"'","FASILITAS");
RDebugUtils.currentLine=2162717;
 //BA.debugLineNum = 2162717;BA.debugLine="ExecuteRemoteQuery(\"SELECT O.office_building_id";
_executeremotequery("SELECT O.office_building_id, O.name_of_office_building, O.building_area, O.land_area, O.parking_area, O.standing_year, O.electricity_capacity, O.address, O.type_of_construction, O.type_of_office, ST_X(ST_Centroid(O.geom)) As longitude, ST_Y(ST_CENTROID(O.geom)) As latitude,T.name_of_type As constr, J.name_of_type As typeof,	ST_AsText(geom) As geom	FROM office_building As O LEFT JOIN type_of_construction As T ON O.type_of_construction=T.type_id LEFT JOIN type_of_office As J ON O.type_of_office=J.type_id WHERE O.office_building_id='"+mostCurrent._ids+"'","DATA");
 break; }
case 2: {
RDebugUtils.currentLine=2162721;
 //BA.debugLineNum = 2162721;BA.debugLine="tabRoute.Color = tab_unclicked";
mostCurrent._tabroute.setColor(_tab_unclicked);
RDebugUtils.currentLine=2162722;
 //BA.debugLineNum = 2162722;BA.debugLine="tabDetail.Color = tab_unclicked";
mostCurrent._tabdetail.setColor(_tab_unclicked);
RDebugUtils.currentLine=2162723;
 //BA.debugLineNum = 2162723;BA.debugLine="tabGallery.Color = tab_clicked";
mostCurrent._tabgallery.setColor(_tab_clicked);
RDebugUtils.currentLine=2162724;
 //BA.debugLineNum = 2162724;BA.debugLine="FunctionAll.setCornerRadii(tabRoute,25,25,0,0,0";
mostCurrent._functionall._setcornerradii(mostCurrent.activityBA,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(mostCurrent._tabroute.getObject())),(float) (25),(float) (25),(float) (0),(float) (0),(float) (0),(float) (0),(float) (25),(float) (25));
RDebugUtils.currentLine=2162725;
 //BA.debugLineNum = 2162725;BA.debugLine="FunctionAll.setCornerRadii(tabGallery,0,0,25,25";
mostCurrent._functionall._setcornerradii(mostCurrent.activityBA,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(mostCurrent._tabgallery.getObject())),(float) (0),(float) (0),(float) (25),(float) (25),(float) (25),(float) (25),(float) (0),(float) (0));
RDebugUtils.currentLine=2162727;
 //BA.debugLineNum = 2162727;BA.debugLine="AddPicture.Visible=True";
mostCurrent._addpicture.setVisible(anywheresoftware.b4a.keywords.Common.True);
RDebugUtils.currentLine=2162728;
 //BA.debugLineNum = 2162728;BA.debugLine="ProgressDialogShow(\"Loading...\")";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,BA.ObjectToCharSequence("Loading..."));
RDebugUtils.currentLine=2162729;
 //BA.debugLineNum = 2162729;BA.debugLine="ExecuteRemoteQuery(\"SELECT photo_url, upload_da";
_executeremotequery("SELECT photo_url, upload_date FROM office_building_gallery WHERE office_building_id='"+mostCurrent._ids+"'","Download");
 break; }
}
;
