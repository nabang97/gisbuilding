...
Sub Activity_Create(FirstTime As Boolean)
	...
	WebViewTest.LoadURL("https://gisbuildingkotogadang.herokuapp.com/worship_building.php")
...
Sub Activity_Resume
	...
	Dim j As HttpJob
	j.Initialize("",Me)
	j.Download(Main.Server&"mobile/datat4ibadah.php")
...
Sub PanelListItem_Click
	...
	Log("NAMA BUILDING: "&nameBuilding)
	StartActivity(WorshipDetail)
End Sub
